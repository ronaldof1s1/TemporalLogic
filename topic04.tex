...
\begin{frame}{Semanthics}
	...
	\begin{itemize}
		...
		\item $\M,s \vDash \E\X \varphi$ iff exists $s_1$ that $s \to s_1$ and $M,s_1 \vDash \varphi$. This, $\E\X$ says: ``in some next state...''
		\item $M,s, \vDash \A\G \varphi$ iff for all paths $s_1 \to s_2 \to s_3 \to ...$
	\end{itemize}
\end{frame}